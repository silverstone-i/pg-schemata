# ADR-0009: Excel I/O Library Migration (exceljs → xlsxjs → tablsx)
...
3. **tablsx** (v1.3.0) — Current. Clean WorkbookReader/WorkbookBuilder API, no problematic transitive dependencies.

## Decision

tablsx. Each migration was driven by dependency health concerns, not feature gaps.

## Consequences

- **Accepted trade-off:** tablsx is a newer package with a smaller ecosystem than exceljs.
